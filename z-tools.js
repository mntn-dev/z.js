...
var C='\u200c'/*ZWNJ*/,D='\u200d'/*ZWJ*/,
B=(Array(33).join(D)+Array(33).join(C)),//used as header in Parts-mode; \x00\x00\x00\x00\xff\xff\xff\xff
p=!1,o='',l=0;
...
l++;o+=(String.fromCharCode(parseInt(d[j].replace(/\u200c/g,'0').replace(/\u200d/g,'1'),2)));
}
